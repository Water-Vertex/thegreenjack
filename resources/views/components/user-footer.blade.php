...
<footer class="bg-[#1a1f2b] text-gray-300">
    ...
    <div class="container mx-auto px-4 max-w-7xl py-12">
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-8">
            ...
            <div>
                ...
                <ul class="space-y-2 text-sm">
                    <li><a href="#" class="text-gray-400 hover:text-[#5B9F01] transition">About Us</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-[#5B9F01] transition">Privacy Policy</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-[#5B9F01] transition">Terms & Conditions</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-[#5B9F01] transition">Shipping Info</a></li>
                    <li><a href="#" class="text-gray-400 hover:text-[#5B9F01] transition">Site Map</a></li>
                </ul>
            </div>

            <!-- Column 5: Follow Us / Payment Methods -->
            <div>
                <h3 class="text-white font-semibold text-lg mb-4">Follow Us</h3>
                <div class="flex gap-4 mb-6">
                    <a href="#" class="text-gray-400 hover:text-[#5B9F01] transition text-xl"><i class="fab fa-facebook-f"></i></a>
                    <a href="#" class="text-gray-400 hover:text-[#5B9F01] transition text-xl"><i class="fab fa-twitter"></i></a>
                    <a href="#" class="text-gray-400 hover:text-[#5B9F01] transition text-xl"><i class="fab fa-instagram"></i></a>
                    <a href="#" class="text-gray-400 hover:text-[#5B9F01] transition text-xl"><i class="fab fa-youtube"></i></a>
                    <a href="#" class="text-gray-400 hover:text-[#5B9F01] transition text-xl"><i class="fab fa-pinterest-p"></i></a>
                </div>
                <h3 class="text-white font-semibold text-lg mb-3">Payment Methods</h3>
    ...
    <!-- Bottom Bar -->
    <div class="border-t border-gray-700 py-5">
        <div class="container mx-auto px-4 max-w-7xl">
            <div class="flex flex-col md:flex-row justify-between items-center gap-3 text-sm text-gray-400">
                <p>&copy; 2026 The Green Jack. All rights Reserved.</p>
                <div class="flex gap-6">
                    <a href="#" class="hover:text-[#5B9F01] transition">Privacy Policy</a>
                    <a href="#" class="hover:text-[#5B9F01] transition">Terms of Use</a>
                    <a href="#" class="hover:text-[#5B9F01] transition">Sitemap</a>
                </div>
            </div>
        </div>
    </div>
